...
namespace Lingya.Xpf.Behaviors {
    public abstract class ControlBehavior<TSource> : Behavior<DependencyObject> where TSource : class {
        ...
        ///             </summary>
        /// <returns> </returns>
        public static readonly DependencyProperty SourceProperty = DependencyProperty.Register("Source", typeof(TSource), typeof(ControlBehavior<TSource>),
            new PropertyMetadata(null, (d, e) => ((ControlBehavior<TSource>)d).OnSourceChanged()));

        /// <summary>
        /// 标题属性
        /// </summary>
        public static readonly DependencyProperty TitleProperty = DependencyProperty.Register("Title", typeof(string), typeof(ControlBehavior<TSource>));

        /// <summary>
        /// 构造方法 继承类必须 构造 ResultCommand
        /// </summary>
        protected ControlBehavior() {
        ...
        protected ICommand ResultCommand { get; set; }
        ...
        public TSource Source {
            get {
                return (TSource)GetValue(SourceProperty);
            }
            set {
